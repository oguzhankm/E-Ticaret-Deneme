<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr height="100" bgcolor="#FF9900">
        <td align="left"><h2 style="color: #FFFFFF">&nbsp;BANKA HESAPLARIMIZ</h2></td>
    </tr>
    <tr height="50">
    ...
    <tr>
        <td align="left"><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr><?php
                ...
                ?>
                    <td  width="348">
                        <table style="border: 1px dashed #CCCCCC; margin-bottom: 10px;" align="center" border="0" cellpadding="0" cellspacing="0">
                            <tr height="40">
                                <td>
                                <td colspan="4" align="center" ><img style="margin-top: 10px;" src="Resimler/<?php echo DonusumleriGeriDondur($Kayit["BankaLogosu"]);?>" border="0"></td>
                                </td>
                            </tr>
                            <tr height="25">
                                <td width="5">&nbsp;</td>
                            ...
                            <tr height="25">
                                ...
                                <td><b>IBAN No</b></td>
                                <td><b>:</b></td>
                                <td style="font-size: 13px;"><?php echo IbanBicimlendir(DonusumleriGeriDondur($Kayit["IbanNumarasi"]));?></td>
                            </tr>
                        </table>
                    </td>
                    <?php
