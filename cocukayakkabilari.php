...
$ToplamKayitSayisiSorgusu				=	$VeritabaniBaglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Çocuk Ayakkabısı' AND Durumuuu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC");
