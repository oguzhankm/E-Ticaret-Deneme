        ...
        if ($GelenDosyaTuru == "img/jpg"){
                if (move_uploaded_file($GelenDosyaTempAdi, $Olustur)){

                        echo "Yükleme İşlemi Başarıyla Tamamlandı" . "<br />";
                        ...
                        echo "Dosya Yüklenme Sırasında Beklenmeyen Bir Hata Oluştu";
                }
        }else{
                echo "Dosya Yüklenme Sırasında İstenmeyen Bir Dosya Algılandı";
        }
