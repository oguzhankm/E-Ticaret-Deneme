...
<head>
    ...
    <table width="1000" height="600" align="center" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td width="200" height="400" valign="top" bgcolor="#CCCCCC">Anasayfa</td>
            ...
            <td width="300" height="400" valign="top">
                <?php if(isset($_SESSION["Kullanici"])){ ?>
                        ...
                        <table width="300">
                            ...
                            <tr>
                                <td height="30" align="right"><a href="cikis.php">Çıkış Yap</a></td>
                            </tr>
                        </table>
                ...
                <?php }else{?>
                    <form action="uyegiris.php" method="post">
                        <table width="300">
                            ...
                            <tr>
                                <td colspan="3" height="30" align="right"><a href="yeniuye.php">Yeni Üye Ol</a></td>
                            </tr>
                        </table>
                    </form>
                <?php } ?>
