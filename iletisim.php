<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="500" valign="top">
			<form action="index.php?SK=17" method="post">
				<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr height="40">
						<td style="color:#FF9900"><h3>Bir Sorunuz mu Var? Bizlere Her Konuda Yazabilirsiniz.</h3></td>
					</tr>
					<tr height="30">
		...
		<td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="2" align="left">İsim Soyisim, E-Mail adresi ve ya cep telefonu bilgileri rastgele veya geçersiz şekilde doldurmak suretiyle gönderilen mesajlar.</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="left">Extra Eğitim kullanıcı hesaplaro hakkında (Örneğin; Bilgi edinme, şifre talebi vb. gibi) herhangi bir yakını, arkadaşı vb gibi 3. şahıslar tarafından gönderilen mesajlar</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="left">Sitei kurum kuruluşlar ile ilgili reklam ve ya tanıtım içeren mesajlar.</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
			...
			<tr>
				<td colspan="2" align="left">Politik ve ya siyasi içerikli mesajlar.</td>
			</tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2" align="left">Yukarıda belirtilmiş olan vb. gibi konularda gönderilecek olan tüm mesajlar, içeriği her ne olursa olsun değerlendirmeye alınmayacak olup,
                    herhangi bir şekilde cevap dönüşü yapılmayacaktır.</td>
            </tr>
