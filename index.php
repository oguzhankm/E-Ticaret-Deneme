                    ...
                    <td>
                        ...
                        <table width="873" height="30" align="center" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="156" class="AnaMenu"><b><a href="erkek-ayakkabilari">Erkek Ayakkabıları</a></b>
                                </td>
                                <td width="156" class="AnaMenu"><b><a href="kadin-ayakkabilari">Kadın Ayakkabıları<a/></b>
                                </td>
                                <td width="134" class="AnaMenu"><b><a href="index.php?SK=86">Çocuk Ayakkabıları</a></b>
                                </td>
                            </tr>
                        </table>
            ...
            <table width="1065" align="center" border="0" cellspacing="0" cellpadding="0" bgcolor="#F9F9F9">
                ...
                <tr height="30">
                    ...
                    if (isset($_SESSION["Kullanici"])){
                        ...
                        ?>
                        <td class="AltMenusu"><a href="uye-giris">Giriş Yap</a></td>
                        <?php
                    }
                    ?>
                    <td>&nbsp;</td>
                ...
                <tr height="30">
                    ...
                    if (isset($_SESSION["Kullanici"])){
                        ...
                        ?>
                        <td class="AltMenusu"><a href="yeni-uye-kayit">Yeni Üye Ol</a></td>
                        <?php
                    }
                    ?>
                    <td>&nbsp;</td>
