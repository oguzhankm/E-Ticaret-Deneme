                                ...
                                foreach($UrunKayitlari as $Kayit){
                                    ...
                                    <td width="191" valign="top">
                                        <table width="191" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"> <!-- border: 1px solid #CCCCCC; -->
                                            <tr height="40">
                                                <td align="center"><a href="erkek-ayakkabilari/<?php echo SEO(DonusumleriGeriDondur($Kayit["UrunAdi"])); ?>/<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img src="Resimler/UrunResimleri/Erkek/<?php echo DonusumleriGeriDondur($Kayit["UrunResmiBir"]); ?>" border="0" width="185" height="247"></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="191" align="center"><a href="erkek-ayakkabilari/<?php echo SEO(DonusumleriGeriDondur($Kayit["UrunAdi"])); ?>/<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>" style="color: #FF9900; font-weight: bold; text-decoration: none;">Erkek Ayakkabısı</a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="191" align="center"><a href="erkek-ayakkabilari/<?php echo SEO(DonusumleriGeriDondur($Kayit["UrunAdi"])); ?>/<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>" style="color: #646464; font-weight: bold; text-decoration: none;"><div style="width: 191px; max-width: 191px; height: 20px; overflow: hidden; line-height: 20px;"><?php echo DonusumleriGeriDondur($Kayit["UrunAdi"]); ?></div></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="191" align="center"><a href="erkek-ayakkabilari/<?php echo SEO(DonusumleriGeriDondur($Kayit["UrunAdi"])); ?>/<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img src="Resimler/<?php echo $PuanResmi; ?>" border="0"></a></td>
                                            </tr>
                                            <tr height="25">
                                                <td width="191" align="center"><a href="erkek-ayakkabilari/<?php echo SEO(DonusumleriGeriDondur($Kayit["UrunAdi"])); ?>/<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>" style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo FiyatBicimlendir($UrunFiyatiHesapla); ?> TL</a></td>
                                            </tr>
