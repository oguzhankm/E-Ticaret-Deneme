            ...
            <td width="500" valign="top">
                <form action="index.php?SK=71" method="post">
                    <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="30">
                            <td  valign="top" align="left"><input type="mail" name="Adres" class="InputAlanlari"></td>
                        </tr>
                        <!--İlçe-->
                        <tr height="30">
                        ...
                        <!--Buton Kısmı-->
                        <tr height="40">
                            <td colspan="2" align="center"><input type="submit" value="Adres Kaydet" class="YesilButon"></td>
                        </tr>
                    </table>
                </form>
            </td>
