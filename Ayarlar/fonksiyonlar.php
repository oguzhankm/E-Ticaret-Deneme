...
$ResimKlasoruYolu    =   "/Resimler/"; //Kendi localhostumuza veya internet üzerindeki dosya yolumuza göre yazılacak
...
function UcGunIleriTarihBul($gun = 3){
    global $ZamanDamgasi;
    $BirGun   = 86400;
    $Hesapla  = $ZamanDamgasi +($gun*$BirGun);
