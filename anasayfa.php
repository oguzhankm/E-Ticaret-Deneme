        ...
        <td>
            <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr><?php
                    ...
                    $EnYeniUrunEnYeniUrunSatirlarilari = $EnYeniUrunlerSorgusu->fetchAll(PDO::FETCH_ASSOC);

                    $EnYeniDonguSayisi = 1;

                    foreach ($EnYeniUrunEnYeniUrunSatirlarilari as $EnYeniUrunSatirlari) {
                        ...
                        <td width="205" valign="top">
                            <table width="205" align="left" border="0" cellpadding="0" cellspacing="0"
                                   style="margin-bottom: 10px;">
                                <tr height="40">
                                    <td align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>"><img
                                                    src="Resimler/UrunResimleri/<?php echo $EnYeniUrunResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["UrunResmiBir"]); ?>"
                                                    border="0" width="205" height="273"></a></td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>"
                                                style="color: #FF9900; font-weight: bold; text-decoration: none;"><?php echo DonusumleriGeriDondur($EnYeniUrununTuru); ?></a>
                                    </td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                ...
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>"><img
                                                    src="Resimler/<?php echo $EnYeniPuanResmi; ?>" border="0"></a></td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>"
                                                style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo FiyatBicimlendir($EnYeniUrunFiyatiHesapla); ?>
                                            TL</a></td>
                                </tr>
        ...
        <td>
            <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr><?php
                    ...
                    $EnPopulerUrunEnPopulerUrunSatirlarilari = $EnPopulerUrunlerSorgusu->fetchAll(PDO::FETCH_ASSOC);

                    $EnPopulerDonguSayisi = 1;

                    foreach ($EnPopulerUrunEnPopulerUrunSatirlarilari as $EnPopulerUrunSatirlari) {
                        ...
                        <td width="205" valign="top">
                            <table width="205" align="left" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr height="40">
                                    <td align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>"><img
                                                    src="Resimler/UrunResimleri/<?php echo $EnPopulerUrunResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["UrunResmiBir"]); ?>"
                                                    border="0" width="205" height="273"></a></td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>"
                                                style="color: #FF9900; font-weight: bold; text-decoration: none;"><?php echo DonusumleriGeriDondur($EnPopulerUrununTuru); ?></a>
                                    </td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                ...
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>"><img
                                                    src="Resimler/<?php echo $EnPopulerPuanResmi; ?>" border="0"></a>
                                    </td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>"
                                                style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo FiyatBicimlendir($EnPopulerUrunFiyatiHesapla); ?>
                                            TL</a></td>
                                </tr>
        ...
        <td>
            <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr><?php
                    ...
                    $EnCokSatanUrunEnCokSatanUrunSatirlarilari = $EnCokSatanUrunlerSorgusu->fetchAll(PDO::FETCH_ASSOC);

                    $EnCokSatanDonguSayisi = 1;

                    foreach ($EnCokSatanUrunEnCokSatanUrunSatirlarilari as $EnCokSatanUrunSatirlari) {
                        ...
                        <td width="205" valign="top">
                            <table width="205" align="left" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr height="40">
                                    <td align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>"><img
                                                    src="Resimler/UrunResimleri/<?php echo $EnCokSatanUrunResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["UrunResmiBir"]); ?>"
                                                    border="0" width="205" height="273"></a></td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>"
                                                style="color: #FF9900; font-weight: bold; text-decoration: none;"><?php echo DonusumleriGeriDondur($EnCokSatanUrununTuru); ?></a>
                                    </td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                ...
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>"><img
                                                    src="Resimler/<?php echo $EnCokSatanPuanResmi; ?>" border="0"></a>
                                    </td>
                                </tr>
                                <tr height="25">
                                    <td width="205" align="center"><a
                                                href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>"
                                                style="color: #0000FF; font-weight: bold; text-decoration: none;"><?php echo FiyatBicimlendir($EnCokSatanUrunFiyatiHesapla); ?>
                                            TL</a></td>
                                </tr>
                ...
                <tr>
                    ...
                    <td width="258">
                        <table width="258" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center"><b>Güvenli Alışveriş</b></td>
                            </tr>
                            <tr>
                    ...
                    <td width="258">
                        <table width="258" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center">Dilediğiniz her cihazdan erişim kolaylığı</td>
                            </tr>
                        </table>
                    </td>
                    <td width="11">&nbsp;</td>
                    <td width="258">
                        <table width="258" align="center" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td align="center"><b>İade Garantisi</b></td>
                            </tr>
                            <tr>
                                <td align="center">14 gün içerisinde koşulsuz şartsız iade garantisi</td>
                            </tr>
                        </table>
                    </td>
                </tr>
